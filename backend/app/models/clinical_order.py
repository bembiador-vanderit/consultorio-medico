...
class LaboratoryTest(TenantOwned, Base):
...
class LaboratoryOrder(TenantOwned, Base):
...
class LaboratoryOrderItem(TenantOwned, Base):
...
class StudyOrder(TenantOwned, Base):
...
class StudyOrderItem(TenantOwned, Base):
