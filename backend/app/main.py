...
from app.api.routes import appointments, auth, centers, clinical_addenda, clinical_catalog, clinical_coverages, clinical_history, communications, diagnoses, doctor_availability, follow_ups, health, insurance, localities, patients, prescriptions, reports, report_communications, users, vital_signs
