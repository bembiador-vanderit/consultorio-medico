...
from app.api.routes import appointments, auth, centers, clinical_catalog, clinical_coverages, clinical_history, communications, diagnoses, doctor_availability, follow_ups, health, insurance, localities, patients, prescriptions, reports, report_communications, users, vital_signs
...
for router in (health.router, auth.router, users.router, localities.router, centers.router, patients.router, insurance.router, clinical_history.router, diagnoses.router, prescriptions.router, vital_signs.router, appointments.router, clinical_coverages.router, doctor_availability.router, follow_ups.router, communications.router, clinical_catalog.router, reports.router, report_communications.router):
