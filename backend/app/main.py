...
from app.api.routes import appointments, auth, centers, clinical_catalog, clinical_history, communications, doctor_availability, follow_ups, health, insurance, localities, patients, reports, report_communications, users
...
for router in (health.router, auth.router, users.router, localities.router, centers.router, patients.router, insurance.router, clinical_history.router, appointments.router, doctor_availability.router, follow_ups.router, communications.router, clinical_catalog.router, reports.router, report_communications.router):
