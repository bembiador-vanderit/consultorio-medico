              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="flex flex-wrap items-end justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {current && canAddAddendum(current) && <button type="button" onClick={() => openAddendum(current)} className="rounded-lg bg-violet-700 px-4 py-2 font-medium text-white">Agregar nota adicional</button>}
                  </div>
                </div>
              </div>
