...
export default function ConsultationWorkspace({ appointment, onBack }: Props) {
  ...
  return <section>
    ...
    <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]"><div className="space-y-6">
      <AnamnesisModule patientDateOfBirth={appointment.patient_date_of_birth} episodeId={appointment.id} appointmentReason={context?.appointment_reason ?? appointment.reason} history={saved} completed={isCompleted} saving={saving} onSave={saveHistory} />
